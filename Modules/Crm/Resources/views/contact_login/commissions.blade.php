        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    {!! Form::select('crm_contact_id', $crm_contact_persons, null, ['style'=>'width: 100%','class' => 'form-control select2', 'id' => 'crm_contact_id', 'placeholder' => __('messages.all')]); !!}
                </div>    
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    {!! Form::label('location_id', __('sale.location') . ':') !!}
                    {!! Form::select('location_id', $business_locations, null, ['style'=>'width: 100%','class' => 'form-control select2', 'id' => 'location_id', 'placeholder' => __('messages.all')]); !!}
                </div>    
            </div>
            <div class="col-md-4">
            	<div class="form-group">
